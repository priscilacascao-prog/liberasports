        ...
        try {
            ...
            if (saleEntersProduction && saleWhatsapp.trim()) {
                ...
                const msgLines = [
                    ...
                    ...(saleDeliveryMethod === 'RETIRADA' ? ['', '_Endereço de retirada: Rua Manguapé, Quadra 40-A, Lote 01-A, Vila Alzira, Aparecida de Goiânia-GO, CEP: 74.913-350_'] : []),
                    '',
        ...
        try {
            ...
            if ((currentStatus === 'AGUARDANDO APROVAÇÃO' || currentStatus === 'PEDIDO FEITO') && orderData?.client_whatsapp) {
                ...
                const msgLines = [
                    ...
                    `*Pedido:* ${orderNumber}`,
                    `*Valor:* R$ ${formattedValue}`,
                    ...(orderData.delivery_method === 'RETIRADA' ? ['', '_Endereço de retirada: Rua Manguapé, Quadra 40-A, Lote 01-A, Vila Alzira, Aparecida de Goiânia-GO, CEP: 74.913-350_'] : []),
                    '',
                    'Acompanhe seu pedido em tempo real:',
                    trackingUrl,
                    '',
    ...
    const handleCreateOrder = async (e: React.FormEvent) => {
        ...
        try {
            ...
            const msgLines = [
                ...
                `*Pagamento:* ${paymentMethod}`,
                ...(deliveryMethod === 'RETIRADA' ? ['', '_Endereço de retirada: Rua Manguapé, Quadra 40-A, Lote 01-A, Vila Alzira, Aparecida de Goiânia-GO, CEP: 74.913-350_'] : []),
                '',
                'Acompanhe seu pedido em tempo real:',
                trackingUrl,
                '',
